...
### 🔍 Digital Forensics
Investigated files, artefacts and metadata to identify hidden information and recover challenge flags.

### 🔐 Cryptography
Analysed encoded and encrypted data and applied appropriate decoding and decryption techniques.
